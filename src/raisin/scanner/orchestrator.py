...
from raisin.config import RaisinConfig, config_fingerprint, load_config
from raisin.constants.cache import CACHE_FILENAME
from raisin.constants.engines import ENGINE_DSL, REMOVED_ENGINE_CHOICES
from raisin.constants.ids import FINDING_ID_HEX_LENGTH
from raisin.exceptions import ConfigError, SkillParseError
from raisin.io import file_sha256
from raisin.model import Evidence, Finding, FindingCandidate, ScanResult
...
from raisin.scanner.discovery import derive_skill_name, discover_skill_files
from raisin.scanner.score import aggregate_overall_score, aggregate_severity, severity_counts, severity_from_score
from raisin.types import CacheNamespace, CachePayload, Confidence, Severity
...
def scan_workspace(
    *,
    ...
    if profile is not None:
        from raisin.constants.profiles import VALID_PROFILES
    ...
    from raisin.dsl.errors import DslError
    ...
    for skill_name in sorted(findings_by_skill):
        ...
        if out is not None:
            from raisin.reporting.writer import write_skill_reports

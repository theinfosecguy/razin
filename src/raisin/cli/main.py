...
from raisin.constants.engines import CLI_ENGINE_CHOICES, ENGINE_DSL
from raisin.exceptions import ConfigError, RaisinError
from raisin.reporting.stdout import StdoutReporter
from raisin.scanner import scan_workspace


def build_parser() -> argparse.ArgumentParser:
    """Build top-level CLI parser."""
    parser = argparse.ArgumentParser(prog="raisin", description="Raisin skill scanner")

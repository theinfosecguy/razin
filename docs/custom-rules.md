...
| `raw_text` | `hint_count`, `keyword_in_text`, `hidden_instruction_scan`, `bidi_control_scan`, `payload_decode_scan`, `data_sensitivity_check`, `confusable_identifier_scan`, `remote_reference_scan` | prose-level pattern detection |

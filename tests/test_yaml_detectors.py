...
class TestMcpEndpointParity:
    """MCP_ENDPOINT: YAML vs Python parity."""

    def test_risky_fixture(self, basic_repo_root: Path) -> None:
    ...
    def test_benign_fixture(self, basic_repo_root: Path) -> None:
    ...
    def test_mcp_url_triggers(self, tmp_path: Path) -> None:
        content = """---
name: mcp-test
---
# MCP Test
...
"""
    ...
    def test_allowlisted_mcp_no_finding(self, tmp_path: Path) -> None:
        content = """---
name: mcp-allow
---
# MCP Allow
...
class TestAuthConnectionParity:
    """AUTH_CONNECTION: YAML vs Python parity."""
    ...
    def test_auth_with_strong_and_weak_hints(self, tmp_path: Path) -> None:
        content = """---
name: auth-test
---
# Auth Test
...
"""
    ...
    def test_no_strong_hints_no_finding(self, tmp_path: Path) -> None:
        content = """---
name: weak-only
---
# Weak Only
...
"""
    ...
    def test_negated_auth_no_finding(self, tmp_path: Path) -> None:
        content = """---
name: negated
---
# Negated Auth
...
class TestOpaqueBlobParity:
    """OPAQUE_BLOB: YAML vs Python parity."""
    ...
    def test_high_entropy_blob(self, tmp_path: Path) -> None:
...
"""
    ...
    def test_short_value_no_finding(self, tmp_path: Path) -> None:
        content = """---
name: short-val
---
# Short
...
"""
    ...
    def test_prose_excluded(self, tmp_path: Path) -> None:
...
class TestYamlSchemaValidation:
    """Schema validator rejects invalid YAML rules."""
...
class TestYamlLoader:
    ...
    def test_yaml_detector_exposes_version(self) -> None:
        detectors = load_yamls(rule_ids=frozenset({"MCP_ENDPOINT"}))
        assert detectors[0].version == 1

    def test_yaml_detector_exposes_source_yaml(self) -> None:
